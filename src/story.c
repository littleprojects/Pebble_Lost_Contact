...
//batterien							//153
		...
		{ 202,210,  1, TEXT, "Their implicators are green."},
...
//Kabelfarbe								204		
		...
		{ 283,285,  1, TEXT, "I’ll connect the other one."},
		...
		{ 296,297,  2, INFO, "[waek signal]"},
		{ 297,350,  2, INFO, "[Signal lost]"},
//Akku Bad way							221
...
//Kabelfarbe								239
		...
		{ 337,340,  1, TEXT, "Ok, cord connected."},	
